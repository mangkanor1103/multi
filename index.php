...
<body class="bg-gray-100 text-gray-800">
    ...
    <header class="bg-green-500 text-white py-8 shadow-lg">
        <div class="max-w-4xl mx-auto text-center">
            <h1 class="text-4xl font-bold">Welcome to Hanuno Translation</h1>
    ...
    <main class="max-w-4xl mx-auto mt-12 text-center">
        <!-- Intro Section -->
        <section class="mb-12">
            <img src="https://via.placeholder.com/600x300" alt="Translation Illustration" class="mx-auto rounded-lg shadow-md mb-6">
        ...
        <section class="mb-12">
            ...
            <div class="flex justify-center space-x-6">
                ...
                <a href="test.php" class="bg-green-500 text-white px-8 py-4 rounded-lg text-lg font-medium hover:bg-green-600 transition shadow-lg">
                    Mangyan Keyboard
                </a>
            </div>
        </section>
        ...
        <section class="bg-white p-8 rounded-lg shadow-md">
            <h2 class="text-2xl font-semibold mb-6">Why Choose Hanuno Translation?</h2>
